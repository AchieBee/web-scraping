...
# Extract questions based on their HTML tags and classes
questions = []

# Adjust this class name according to the actual HTML structure
for div in soup.find_all('div', class_='grid grid-cols-1'):
    question_text = div.get_text(strip=True)  # Changed li to div
    questions.append(question_text)

# Print or process the extracted questions
for idx, question in enumerate(questions):
    print(f"Question {idx+1}: {question}")

# Optionally, save the questions to a file
